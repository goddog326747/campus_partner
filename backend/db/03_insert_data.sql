...
('五一假期想去成都吃火锅', '有没有想去成都旅游的同学？计划去宽窄巷子、锦里，还有熊猫基地。求组队！', '旅行出游', 2, DATE_SUB(NOW(), INTERVAL 3 DAY)),
('BW漫展求集邮', '这周末去BW，出的是原神里的角色，有没有摄影师或者一起逛展的小伙伴？', '漫展搭子', 3, DATE_SUB(NOW(), INTERVAL 12 HOUR)),
